    ...
    <ion-header class="theIonHeader" v-if="mapHeader"
      ...
      <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <div @click="router.push('/profile')"
          class="text-start me-1 d-flex flex-column justify-content-start align-items-end " style=" font-weight: 600; width: 4rem;">
          ...
          <div style="line-height: 1.1rem;font-size: 0.9rem;" :class="'d-flex pe-2 flex-column text-' + (lang === 'ar' ? 'end' : 'start')">
    ...
    <ion-header v-if="!mapHeader"
      ...
      <div class="d-flex justify-content-between align-items-center my-3">
        ...
        <div @click="router.push('/profile')" class="text-start" style=" font-weight: 600;"> <img
          ...
          <div style="line-height: 1.1rem;" class="d-flex flex-column pe-3">
