<template>
    <div class="login-button facebook">
        <button @click="facbookLogin" ></button>
    </div> 

    <!-- Modal -->
    <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasFacbook" aria-labelledby="offcanvasBottomLabel">
...
export default {
    ...
    setup(){
        ...
        onMounted(()=>{
            offcanvas = new bootstrap.Offcanvas(document.querySelector('#offcanvasFacbook'));
        ...
        // window.facbookLogin = (response)=>{  
            window.facbookLogin = function() {
            // <!-- Initialize the SDK with your app and the Graph API version for your app -->
            FB.init({
                      appId            : '291210183820837',
                      xfbml            : true,
                    });
            ...
            // const url = `${process.env.VUE_APP_API_URL}/api/facbook-login`;
